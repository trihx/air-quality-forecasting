...
### Community 7 - "load_raw_data"
Cohesion: 0.08
Nodes (32): main(), Compare Data Strategies — Run all 4 imputation strategies and evaluate.  PRINC, Save results to JSON., _save_results(), main(), Compute R², RMSE, MAPE for ALL models across ALL horizons. Generates a complete, Temporal Fusion Transformer (TFT) Multi-Horizon Evaluation — Level 5.  Simplif, main() (+24 more)
...
### Community 9 - "chart_factory.py"
Cohesion: 0.08
Nodes (39): Any, Bar, Figure, Scatter, plot_dm_test_heatmap(), plot_mae_trend(), plot_mae_trend_top5(), plot_mase_comparison() (+31 more)

### Community 10 - "_clip_physical_bounds"
Cohesion: 0.09
Nodes (27): prepare_data(), DataFrame, Export ARIMA and SARIMA predictions for AVP dashboard integration.  Runs rolli, Load → clean → impute (same as arima_multi_horizon.py)., main(), prepare_data(), Export TFT predictions for AVP dashboard integration.  Trains the Simplified T, Load → clean → impute → add static features (same as tft_multi_horizon.py). (+19 more)

### Community 11 - "pipeline_walkthrough.py"
Cohesion: 0.09
Nodes (36): cite(), _ensure_css(), IEEE Citation Popup System + Pipeline Step Framework.  Provides two complement, Render a full IEEE-formatted references list at the bottom of a page., Return an HTML-styled circled number for a pipeline step.      This function i, Inject citation CSS. We inject it every time to ensure it persists across Stream, Return an inline HTML tooltip for a citation.      Args:         ref_id: Key, render_references_section() (+28 more)

### Community 12 - "chat_page.py"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (20): Quick verification of the metrics pipeline end-to-end., DataFrame, Reporting Engine — Single Source of Truth for Dashboard metrics.  Loads normaliz, Get best model for all horizons.          Returns:             {"1h": {...}, "6h, Generate ranking table sorted by MAE, with star markers for best.          Args:, Get ranking table formatted for display with ⭐ markers.          Returns DataFra, Get MASE values formatted for chart plotting.          Args:             model_f, Get MAE values formatted for chart plotting.          Returns:             {"Per (+12 more)

### Community 14 - "metrics.py"
Cohesion: 0.09
...
### Community 18 - "impute_missing_data"
Cohesion: 0.09
Nodes (28): _handle_outliers_iqr_all(), main(), DataFrame, v10 Ablation Study — Phase 1: Rebuild data with IQR-truncated PM2.5.  Mô phỏng l, Handle outliers using IQR for ALL columns including PM2.5.      This is the OLD, main(), v8 Phase 4.1 — Re-impute data with KNN past-only fix.  Runs: Raw → Clean → Imp, build_pipeline() (+20 more)

### Community 19 - "test_smoke.py"
Cohesion: 0.07
...
### Community 22 - "build_features"
Cohesion: 0.11
Nodes (22): Cross-reference Audit — Validate ALL experiment results on SAME data.  Purpose:, Debug script — find exact crash point in ensemble pipeline., main(), prepare_data(), P0-8 — Deseasonalizing Transform Experiment.  Hypothesis: PM2.5 has strong dai, Load → clean → impute → build_features (v2)., Rebuild marts data and re-run ML pipeline after leakage fix.  Usage:     uv run, _create_v2_snapshot() (+14 more)

### Community 23 - "v8_statistical_methods.py"
Cohesion: 0.12
Nodes (27): compute_dm_hln(), compute_r2_multi_horizon(), compute_unified_mase(), get_actuals_for_preds(), load_predictions_per_source(), load_target_series(), main(), ndarray (+19 more)

### Community 24 - "test_imputer.py"
Cohesion: 0.10
...
### Community 27 - "_resample"
Cohesion: 0.12
Nodes (21): main(), prepare_data(), DL Retrain v2 — GRU/LSTM with Enhanced Features + Log Transform Comparison.  3, Load → clean → impute → build_features (v2 enhanced) → add CV., prepare_data(), Load → clean → impute → build_features (v2) → add CV., analyze_segments(), main() (+13 more)

### Community 28 - "evaluate_horizon"
Cohesion: 0.09
Nodes (19): add_cv_features(), evaluate_horizon(), GRUModel, LSTMModel, DataFrame, DataLoader, Dataset, Module (+11 more)

### Community 29 - "snapshot_adapter.py"
Cohesion: 0.12
Nodes (22): main(), _compute_best_models(), _compute_top_n(), _derive_models(), extract_mase(), _extract_results(), load_all_normalized(), _normalize_model_entry() (+14 more)

### Community 30 - "v9_retrain_tft.py"
Cohesion: 0.14
...
### Community 33 - "v9_retrain_lgbm.py"
Cohesion: 0.12
...
### Community 34 - "v9_retrain_dl_expert.py"
Cohesion: 0.12
...
### Community 37 - "retrain_v7_full.py"
Cohesion: 0.17
...
### Community 45 - "temporal_train_val_test_split"
Cohesion: 0.13
...
### Community 48 - "patch_v9_metrics.py"
Cohesion: 0.21
...
### Community 56 - "run_residual_diagnostics"
Cohesion: 0.16
Nodes (12): Any, Path, Run diagnostics for all available model predictions.      Args:         predi, Run full residual diagnostics suite.      Args:         y_true: Actual values, run_all_diagnostics(), run_residual_diagnostics(), White noise residuals should pass diagnostics., Autocorrelated residuals should fail Ljung-Box. (+4 more)
...
### Community 62 - "knowledge_base.py"
Cohesion: 0.22
...
### Community 63 - "create_calendar_features"
Cohesion: 0.21
...
### Community 64 - "theme.py"
Cohesion: 0.24
Nodes (12): Unified Visualization Theme Framework (VTF) for PM2.5 Dashboard.  Provides centr, apply_plotly_style(), detect_streamlit_mode(), get_plotly_annotation_style(), get_plotly_template(), get_theme(), Unified Visualization Theme — Single Source of Truth.  Centralized design toke, Get theme dict by mode name.      Args:         mode: 'light' or 'dark'. (+4 more)
...
### Community 70 - "_cubic_spline_fill"
Cohesion: 0.18
...
### Community 73 - "precompute_avp.py"
Cohesion: 0.25
...
### Community 74 - "v9_statistical_methods.py"
Cohesion: 0.29
...
### Community 76 - "deseasonal_fix_leakage.py"
Cohesion: 0.27
