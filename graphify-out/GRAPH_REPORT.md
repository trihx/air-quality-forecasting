...
## Summary
- 2486 nodes · 4669 edges · 304 communities (156 shown, 148 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da7ef3d1`
...
## Communities (304 total, 148 thin omitted)
...
### Community 2 - "_clip_physical_bounds"
Cohesion: 0.08
Nodes (52): main(), Compare Data Strategies — Run all 4 imputation strategies and evaluate.  PRINC, Save results to JSON., _save_results(), main(), prepare_data(), P0-8 — Deseasonalizing Transform Experiment.  Hypothesis: PM2.5 has strong dai, Load → clean → impute → build_features (v2). (+44 more)
...
### Community 5 - "load_raw_data"
Cohesion: 0.08
Nodes (32): ARIMA/SARIMA Multi-Horizon Evaluation — Level 1 Statistical Models.  Compare A, Cross-reference Audit — Validate ALL experiment results on SAME data.  Purpose:, main(), Compute R², RMSE, MAPE for ALL models across ALL horizons. Generates a complete, Debug script — find exact crash point in ensemble pipeline., LSTM/GRU Multi-Horizon Evaluation — Level 4 Deep Learning Models.  Compare LST, Rebuild marts data and re-run ML pipeline after leakage fix.  Usage:     uv run, Temporal Fusion Transformer (TFT) Multi-Horizon Evaluation — Level 5.  Simplif (+24 more)

### Community 6 - "dl_v3_pca_tft.py"
Cohesion: 0.07
Nodes (31): add_cv_features(), GatedLinearUnit, GatedResidualNetwork, GRUModel, LSTMModel, main(), DataFrame, Dataset (+23 more)

### Community 7 - "test_loader.py"
Cohesion: 0.06
...
### Community 8 - "chart_factory.py"
Cohesion: 0.09
Nodes (35): Any, Bar, Figure, Scatter, plot_dm_test_heatmap(), plot_mae_trend(), plot_mae_trend_top5(), plot_mase_comparison() (+27 more)

### Community 9 - "metrics.py"
Cohesion: 0.09
Nodes (27): classification_metrics(), _compute_roc_auc(), evaluate_forecast(), forecast_bias(), mape(), medae(), ndarray, r2_score() (+19 more)

### Community 10 - "ReportingEngine"
Cohesion: 0.08
...
### Community 11 - "explainability_hub.py"
Cohesion: 0.12
...
### Community 19 - "snapshot_adapter.py"
Cohesion: 0.11
...
### Community 22 - "pipeline_walkthrough.py"
Cohesion: 0.13
Nodes (27): cite(), Return an inline HTML tooltip for a citation.      Args:         ref_id: Key, _get_dashboard_content(), _get_pipeline_metrics(), _load_standardized_metrics(), page_pipeline_walkthrough(), Pipeline Walkthrough page for PM2.5 Forecasting Dashboard.  Shows the complete, Step 2: Data Cleaning. (+19 more)
...
### Community 28 - "_evaluate_horizon"
Cohesion: 0.09
...
### Community 30 - "v9_retrain_dl_expert.py"
Cohesion: 0.12
...
### Community 34 - "app.py"
Cohesion: 0.23
Nodes (21): _count_tests(), insight_card(), kpi_card(), main(), page_eda(), page_hyperparams(), page_multi_horizon(), page_overview() (+13 more)

### Community 35 - "retrain_v7_full.py"
Cohesion: 0.17
Nodes (20): eval_model(), main(), prepare_data(), DataFrame, v7 Full Pipeline Retrain — After outlier fix (PM2.5 domain bounds).  Runs ALL, Train, predict, evaluate., LightGBM with Optuna-tuned hyperparameters., RF, GradientBoosting, Stacking, Ensemble. (+12 more)

### Community 36 - "run_experiment"
Cohesion: 0.10
...
### Community 38 - "export_db_to_json.py"
Cohesion: 0.18
...
### Community 39 - "v8_statistical_methods.py"
Cohesion: 0.17
...
### Community 41 - "eda_audit_phase1.py"
Cohesion: 0.18
...
### Community 42 - "evaluate_forecast_full"
Cohesion: 0.21
...
### Community 43 - "v9_rebuild_data.py"
Cohesion: 0.15
...
### Community 44 - "temporal_train_val_test_split"
Cohesion: 0.13
Nodes (11): create_naive_predictions(), DataFrame, ndarray, Series, Data splitter for time series — temporal split, NO shuffle.  Per SKILL.md §6.3:, Split data temporally: oldest → train → val → test → newest.      NEVER shuffles, Create naive baseline predictions for MASE calculation.      Per SKILL.md Level, temporal_train_val_test_split() (+3 more)

### Community 45 - "ContentManager"
Cohesion: 0.16
...
### Community 48 - "thesis_figures.py"
Cohesion: 0.17
Nodes (17): _chart_bootstrap_ci(), _chart_mase_decay(), _chart_residual_bias(), _chart_shap_comparison(), _chart_train_time(), _load_bootstrap_ci(), _load_ljungbox(), _load_shap() (+9 more)

### Community 49 - "_handle_outliers"
Cohesion: 0.16
Nodes (15): _compute_ensemble_preds(), _detect_device(), _load_external_preds(), main(), precompute_horizon(), Pre-compute Actual vs Predicted data for all horizons.  Saves results as JSON, Compute Ensemble predictions from GRU + LightGBM using weights from ensemble JSO, Detect best available PyTorch device. (+7 more)
...
### Community 53 - "run_ml.py"
Cohesion: 0.17
Nodes (15): _get_lightgbm(), get_ml_models(), _get_xgboost(), main(), DataFrame, Series, Level 2-3: ML Models with Walk-Forward Validation.  Usage:     uv run python, Train with walk-forward CV then evaluate on test set.      Per SKILL.md §6.3: (+7 more)
...
### Community 55 - "build_features"
Cohesion: 0.17
Nodes (15): prepare_data(), Load → clean → impute → build_features (v2) → add CV., _create_v2_snapshot(), _evaluate_lgbm(), main(), _prepare_hybrid_data(), _print_comparison(), DataFrame (+7 more)

### Community 56 - "ensemble_multi_horizon.py"
Cohesion: 0.18
...
### Community 57 - "audit_v9_expert_results.py"
Cohesion: 0.21
...
### Community 58 - "statistical_tests.py"
Cohesion: 0.20
...
### Community 61 - "prediction_intervals.py"
Cohesion: 0.19
...
### Community 62 - "impute_missing_data"
Cohesion: 0.19
Nodes (13): _prepare_hybrid_data(), DataFrame, Load raw data and apply Hybrid imputation strategy., main(), _prepare_hybrid_data(), _print_summary(), Linear Models Multi-Horizon Evaluation — Lasso, ElasticNet, Ridge.  Integrates, Save results to JSON. (+5 more)

### Community 63 - "StandardScaler"
Cohesion: 0.18
...
### Community 64 - "tune_and_select.py"
Cohesion: 0.25
...
### Community 65 - "v8_aci_prediction_intervals.py"
Cohesion: 0.19
...
### Community 67 - "knowledge_base.py"
Cohesion: 0.22
...
### Community 68 - "create_calendar_features"
Cohesion: 0.21
...
### Community 69 - "_save"
Cohesion: 0.24
Nodes (10): create_sequences_segment_aware(), evaluate_dl(), main(), DataFrame, v9 Phase 5B.4 — Retrain DL Models (GRU/LSTM).  Retrains PyTorch models (GRU, LST, Create sequences strictly within segments to prevent False Continuity., RNNModel, run_pipeline() (+2 more)

### Community 70 - "run_residual_diagnostics"
Cohesion: 0.19
Nodes (9): Any, Run full residual diagnostics suite.      Args:         y_true: Actual values, run_residual_diagnostics(), White noise residuals should pass diagnostics., Autocorrelated residuals should fail Ljung-Box., Verify output dictionary structure., Verify chart is generated when output_dir is provided., P0-5: Residual Diagnostics — Peixeiro Ch.6. (+1 more)

### Community 71 - "deep_insights_phase4.py"
Cohesion: 0.27
...
### Community 74 - "_cubic_spline_fill"
Cohesion: 0.18
...
### Community 75 - "residual_diagnostics.py"
Cohesion: 0.23
...
### Community 76 - "create_lag_features"
Cohesion: 0.26
...
### Community 78 - "page_content_manager"
Cohesion: 0.18
Nodes (11): load_experiment_results(), load_json(), page_content_manager(), Multi-tab content management — Info Cards, JSON editor, CSV overview., Existing info card editor — PostgreSQL backend., Structured editor for dashboard_content.json., Save dashboard_content.json with backup and trigger RAG re-index., _save_dashboard_json() (+3 more)

### Community 79 - "v9_statistical_methods.py"
Cohesion: 0.29
...
### Community 81 - "deseasonal_fix_leakage.py"
Cohesion: 0.27
...
### Community 82 - "multi_horizon_eval.py"
Cohesion: 0.29
...
### Community 84 - "export_eda_plotly_cache.py"
Cohesion: 0.38
...
### Community 85 - "conclusion_page.py"
Cohesion: 0.27
...
### Community 86 - "create_rolling_features"
Cohesion: 0.29
...
### Community 89 - "TestResultPlausibility"
Cohesion: 0.20
...
### Community 90 - "bootstrap_mase_ci.py"
Cohesion: 0.31
...
### Community 91 - "standardize_metrics.py"
Cohesion: 0.28
...
### Community 93 - "shap_explainability.py"
Cohesion: 0.36
...
### Community 94 - "citations.py"
Cohesion: 0.25
Nodes (7): _ensure_css(), IEEE Citation Popup System + Pipeline Step Framework.  Provides two complement, Render a full IEEE-formatted references list at the bottom of a page., Return an HTML-styled circled number for a pipeline step.      This function i, Inject citation CSS. We inject it every time to ensure it persists across Stream, render_references_section(), step()

### Community 95 - "v10_ablation_compare.py"
Cohesion: 0.31
...
### Community 99 - "sklearn_models_eval.py"
Cohesion: 0.36
...
### Community 100 - "01_autocorrelation_trap.py"
Cohesion: 0.36
...
### Community 101 - "02_erratic_spikes.py"
Cohesion: 0.36
...
### Community 102 - "03_multivariate_shift.py"
Cohesion: 0.36
...
### Community 103 - "audit_knn_temporal_order"
Cohesion: 0.32
...
### Community 104 - "create_diff_features"
Cohesion: 0.32
...
### Community 105 - "TestRmseMaeRatio"
Cohesion: 0.25
...
### Community 106 - "knn_k_sensitivity.py"
Cohesion: 0.38
...
### Community 107 - "fetch_external_data.py"
Cohesion: 0.33
...
### Community 108 - "_tab_pipeline_journey"
Cohesion: 0.38
...
### Community 109 - "validate_data_path"
Cohesion: 0.38
...
### Community 111 - "update_memory.py"
Cohesion: 0.47
...
### Community 112 - "v9_standardize_evaluation.py"
Cohesion: 0.47
...
### Community 113 - "validate_snapshot"
Cohesion: 0.40
...
### Community 114 - "test_features.py"
Cohesion: 0.33
...
### Community 115 - "TestDataIntegrity"
Cohesion: 0.33
...
### Community 117 - "reproduce.sh"
Cohesion: 0.70
Nodes (4): err(), log(), reproduce.sh script, warn()

### Community 120 - "precompute_avp_safe.py"
Cohesion: 0.50
...
- **Why does `build_features()` connect `build_features` to `_clip_physical_bounds`, `load_raw_data`, `dl_v3_pca_tft.py`, `pipeline_walkthrough.py`, `inference.py`, `retrain_v7_full.py`, `v9_rebuild_data.py`, `save_marts_data`, `_handle_outliers`, `temporal.py`, `LightGBMTrainer`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `impute_missing_data`, `create_calendar_features`, `deep_insights_phase4.py`, `create_lag_features`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `create_rolling_features`, `export_models.py`, `shap_explainability.py`, `sklearn_models_eval.py`, `create_diff_features`, `test_features.py`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `impute_missing_data()` connect `impute_missing_data` to `_clip_physical_bounds`, `load_raw_data`, `dl_v3_pca_tft.py`, `test_imputer.py`, `pipeline_walkthrough.py`, `_identify_gaps`, `retrain_v7_full.py`, `_log`, `v9_rebuild_data.py`, `_handle_outliers`, `build_features`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `deep_insights_phase4.py`, `_cubic_spline_fill`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `standardize_metrics.py`, `export_models.py`, `shap_explainability.py`, `sklearn_models_eval.py`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `load_raw_data()` connect `load_raw_data` to `DataValidator`, `_clip_physical_bounds`, `dl_v3_pca_tft.py`, `test_loader.py`, `pipeline_walkthrough.py`, `retrain_v7_full.py`, `v9_rebuild_data.py`, `_handle_outliers`, `build_features`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `impute_missing_data`, `deep_insights_phase4.py`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `standardize_metrics.py`, `export_models.py`, `shap_explainability.py`, `sklearn_models_eval.py`, `validate_data_path`?**
...
- **Should `_clip_physical_bounds` be split into smaller, more focused modules?**
