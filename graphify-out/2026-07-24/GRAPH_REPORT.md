...
## Summary
- 2501 nodes · 4688 edges · 300 communities (151 shown, 149 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 157 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2266923e`
...
- v9_retrain_lgbm.py
- mae
- v9_retrain_dl_expert.py
- inference.py
- _identify_gaps
- test_imputer.py
- v8_statistical_methods.py
- evaluate_forecast_full
- run_experiment
- _evaluate_horizon
- _log
...
- .__init__
- temporal.py
- ensemble_multi_horizon.py
- audit_v9_expert_results.py
...
- StandardScaler
- _remove_duplicates
- v8_aci_prediction_intervals.py
- audit.py
- knowledge_base.py
- create_calendar_features
- arima_multi_horizon.py
- v9_statistical_methods.py
- deep_insights_phase4.py
- main
- main
- v8_audit_knn_temporal.py
- v9_retrain_dl.py
- _cubic_spline_fill
...
- bootstrap_mase_ci.py
- standardize_metrics.py
- run_enhanced_pipeline.py
- shap_explainability.py
- v10_ablation_compare.py
- dl_multi_horizon.py
- main
- linear_models_eval.py
- phase1_normalize_snapshots.py
- sklearn_models_eval.py
- 01_autocorrelation_trap.py
- 02_erratic_spikes.py
- 03_multivariate_shift.py
- metrics.py
- create_diff_features
- knn_k_sensitivity.py
...
- precompute_avp_safe.py
- get_db
- leakage_audit.py
- v9_retrain_ensemble.py
- ._put
- .get_info_card_text
- analyze_gaps.py
- audit_leakage.py
...
- audit_content_deep.py
- audit_crossref.py
- audit_postfix.py
- scratch_append_thesis.py
- scratch_audit_metrics.py
- sync_snapshot.py
- api/__init__.py
- chatbot/__init__.py
...
- 1799 Context
- 1799 Full Text
- 1799 Huongdanviettrinhbaylvths Latsa5 Ctu Qd1799
- 1799 Rules
- 1799 Search Results
- EXPERIMENT RUNS LOG
...
1. `load_raw_data()` - 89 edges
2. `impute_missing_data()` - 79 edges
3. `_remove_duplicates()` - 70 edges
4. `_clip_physical_bounds()` - 70 edges
5. `_resample()` - 69 edges
6. `build_features()` - 69 edges
7. `_handle_outliers()` - 68 edges
8. `_set_datetime_index()` - 66 edges
...
- `export_runs()` --indirect_call--> `Run`  [INFERRED]
  scripts/export_db_to_json.py → src/api/models.py
- `export_run_models()` --indirect_call--> `RunModel`  [INFERRED]
  scripts/export_db_to_json.py → src/api/models.py

## Import Cycles
- None detected.

## Communities (300 total, 149 thin omitted)

### Community 0 - "run_full_eda"
Cohesion: 0.06
Nodes (61): evaluate_tuned_model(), main(), DataFrame, Series, Feature Selection + Optuna Hyperparameter Tuning.  Goal: Beat Persistence base, Tune LightGBM hyperparameters with Optuna., Train tuned model on full training set, evaluate on test., Feature Selection + Optuna Tuning Pipeline. (+53 more)
...
### Community 4 - "PersistenceModel"
Cohesion: 0.07
Nodes (31): get_all_baselines(), HourlyMeanModel, MeanModel, NaiveBaseline, PersistenceModel, DataFrame, ndarray, Series (+23 more)

### Community 5 - "experiments.py"
Cohesion: 0.07
Nodes (50): A single training/evaluation run within an experiment.      One run = one horizo, Run, Verify file integrity by comparing current MD5 with expected hashes from manifes, verify_integrity(), _build_experiment_summary(), create_experiment(), create_metric(), create_run() (+42 more)

### Community 6 - "test_loader.py"
Cohesion: 0.06
Nodes (31): get_data_summary(), Any, Run basic validation checks on dataset.      Args:         df: Input DataFrame., Generate summary statistics about the dataset.      Args:         df: Input Data, validate_dataset(), DataFrame, Tests for data loader module., Should detect duplicated timestamps. (+23 more)

### Community 7 - "ContentManager"
Cohesion: 0.08
Nodes (34): cards_actual_vs_predicted(), cards_ai_assistant(), cards_eda(), cards_experiment_runs(), cards_forecast(), cards_hyperparams(), cards_multi_horizon(), cards_overview() (+26 more)

### Community 8 - "build_features"
Cohesion: 0.09
Nodes (31): Cross-reference Audit — Validate ALL experiment results on SAME data.  Purpose:, main(), Compute R², RMSE, MAPE for ALL models across ALL horizons. Generates a complete, Debug script — find exact crash point in ensemble pipeline., main(), prepare_data(), P0-8 — Deseasonalizing Transform Experiment.  Hypothesis: PM2.5 has strong dai, Load → clean → impute → build_features (v2). (+23 more)

### Community 9 - "run_pca_experiment"
Cohesion: 0.06
...
### Community 10 - "evaluate_forecast"
Cohesion: 0.07
Nodes (30): ndarray, create_leakage_free_stl_target(), GRUModel, main(), Dataset, ndarray, P0-8 FIX — Re-run STL Residual with TRAIN-ONLY STL fitting.  Issue: Previous r, Create STL residual target WITHOUT leakage.      Strategy:         1. Fit STL (+22 more)

### Community 11 - "chat_page.py"
Cohesion: 0.11
Nodes (34): OpenAI, _ensure_index(), _get_knowledge_base(), page_ai_assistant(), AI Assistant page for PM2.5 Forecasting Dashboard.  Provides a chat interface wi, Render AI Assistant chatbot page., Lazy import and get knowledge base singleton., Ensure knowledge base is indexed, re-index if user content changed.      Checks (+26 more)

### Community 12 - "chart_factory.py"
Cohesion: 0.09
Nodes (35): Any, Bar, Figure, Scatter, plot_dm_test_heatmap(), plot_mae_trend(), plot_mae_trend_top5(), plot_mase_comparison() (+27 more)

### Community 13 - "ReportingEngine"
Cohesion: 0.08
Nodes (21): get_model_type(), DataFrame, Reporting Engine — Single Source of Truth for Dashboard metrics.  Loads normaliz, Get best model for all horizons.          Returns:             {"1h": {...}, "6h, Generate ranking table sorted by MAE, with star markers for best.          Args:, Get ranking table formatted for display with ⭐ markers.          Returns DataFra, Get MASE values formatted for chart plotting.          Args:             model_f, Get MAE values formatted for chart plotting.          Returns:             {"Per (+13 more)

### Community 14 - "_set_datetime_index"
Cohesion: 0.09
Nodes (31): main(), Compare Data Strategies — Run all 4 imputation strategies and evaluate.  PRINC, Save results to JSON., _save_results(), _handle_outliers_iqr_all(), main(), DataFrame, v10 Ablation Study — Phase 1: Rebuild data with IQR-truncated PM2.5.  Mô phỏng l (+23 more)

### Community 15 - "explainability_hub.py"
Cohesion: 0.12
Nodes (34): _generate_shapash_html(), _get_best_mase(), _get_hub_pipeline_metrics(), _image_to_plotly(), _insight_card(), _load_json(), page_explainability_hub(), Figure (+26 more)

### Community 16 - "add_cv_features"
Cohesion: 0.08
...
### Community 17 - "Base"
Cohesion: 0.11
Nodes (27): DeclarativeBase, seed(), _delete_experiment(), _load_json_safe(), main(), Path, Sync existing JSON experiment results → Database.  One-shot script that reads al, Load JSON with NaN/Infinity handling. (+19 more)

### Community 18 - "test_smoke.py"
Cohesion: 0.07
...
### Community 21 - "snapshot_adapter.py"
Cohesion: 0.11
Nodes (23): main(), Quick verification of the metrics pipeline end-to-end., _compute_best_models(), _compute_top_n(), _derive_models(), extract_mase(), _extract_results(), load_all_normalized() (+15 more)

### Community 22 - "_resample"
Cohesion: 0.12
Nodes (18): _handle_outliers(), Detect and replace outliers with NaN (will be interpolated later).      Strategy, Resample to regular frequency using mean aggregation., _resample(), get_latest_data(), get_suggestion_values(), PM2.5 Prediction Service — Load exported models and run inference.  Supports:, Load the latest N rows from the processed hybrid dataset.      Returns a DataF (+10 more)
...
### Community 24 - "pipeline_walkthrough.py"
Cohesion: 0.12
Nodes (29): cite(), Return an inline HTML tooltip for a citation.      Args:         ref_id: Key, get_current_version(), Get the currently selected version from session state., Render a small version badge at top of page., render_version_badge(), _get_dashboard_content(), _get_pipeline_metrics() (+21 more)

### Community 25 - "main.py"
Cohesion: 0.11
Nodes (24): FastAPI, Request, health_check(), lifespan(), log_requests(), FastAPI application — PM2.5 Forecasting API.  Endpoints:     - /health, Log all incoming requests with timing., API health check — verifies DB connectivity and model availability. (+16 more)

### Community 26 - "evaluate_horizon"
Cohesion: 0.09
Nodes (19): add_cv_features(), evaluate_horizon(), GRUModel, LSTMModel, DataFrame, DataLoader, Dataset, Module (+11 more)

### Community 27 - "v9_retrain_tft.py"
Cohesion: 0.14
Nodes (22): evaluate_tft(), main(), DataFrame, v9 Phase 5B-1h — TFT 1h Pipeline (OOM Fix).  Uses CPU fallback, base features, a, run_pipeline(), train_tft(), create_sequences_segment_aware(), evaluate_tft() (+14 more)

### Community 28 - "test_evaluation.py"
Cohesion: 0.09
Nodes (14): mape(), nmpiw(), Mean Absolute Percentage Error.      Skips near-zero values to avoid division by, Winkler Score for interval prediction evaluation (Winkler 1972).      Penalizes, Normalized Mean Prediction Interval Width (NMPIW).      Measures average interva, winkler_score(), Tests for evaluation metrics and data splitter., TestEvaluateForecast (+6 more)

### Community 29 - "v9_retrain_lgbm.py"
Cohesion: 0.13
Nodes (22): main(), DataFrame, v9 Phase 5B.3 — Retrain ARIMA/SARIMA.  Retrains Statsmodels ARIMA on high-resolu, Run ARIMA on the largest segment in the training set., run_arima(), eval_model(), main(), DataFrame (+14 more)
...
### Community 31 - "v9_retrain_dl_expert.py"
Cohesion: 0.12
...
### Community 32 - "inference.py"
Cohesion: 0.12
Nodes (17): predict(), Inference router — PM2.5 prediction endpoints.  Endpoints:     POST /predict — R, Predict PM2.5 for a given horizon using specified model.      Supported models:, PredictionRequest, PredictionResponse, Request body for PM2.5 prediction., GRUPredictor, GRUQuantilePredictor (+9 more)

### Community 33 - "_identify_gaps"
Cohesion: 0.13
Nodes (21): _apply_knn_imputation(), _build_knn_features(), _identify_gaps(), DataFrame, Drop all gaps > max_gap. Interpolate only very short gaps (≤2h)., KNN imputation using auxiliary features (temperature, humidity, CO2).      ANTI-, Tiered approach:     - Gap ≤ max_gap_interp: Cubic Spline interpolation     - Ga, Identify contiguous NaN gap segments.      Returns:         DataFrame with colum (+13 more)

### Community 34 - "test_imputer.py"
Cohesion: 0.11
Nodes (17): clean_data(), hourly_data_with_gaps(), DataFrame, Tests for data imputer — multi-strategy missing data recovery.  Each test has ve, KNN feature matrix must NOT contain pm25 (anti-leakage)., ML imputation should fill gaps up to max_gap., Hybrid should be the best or second-best strategy for data retention., Gap identifier should find correct gap segments. (+9 more)

### Community 35 - "v8_statistical_methods.py"
Cohesion: 0.15
Nodes (20): compute_dm_hln(), compute_r2_multi_horizon(), compute_unified_mase(), get_actuals_for_preds(), load_predictions_per_source(), load_target_series(), main(), ndarray (+12 more)

### Community 36 - "evaluate_forecast_full"
Cohesion: 0.17
Nodes (21): _evaluate_horizon(), _predict_and_eval(), DataFrame, Train → predict → evaluate → return metrics., Evaluate sklearn models at a specific forecast horizon., _evaluate_lgbm(), DataFrame, Evaluate LightGBM with v2 features at a specific horizon. (+13 more)

### Community 37 - "run_experiment"
Cohesion: 0.10
Nodes (16): create_deseasonalized_targets(), GRUModel, DataFrame, DataLoader, Dataset, Module, ndarray, Series (+8 more)

### Community 38 - "_evaluate_horizon"
Cohesion: 0.11
Nodes (14): _evaluate_horizon(), GRUModel, LSTMModel, DataLoader, Dataset, Module, ndarray, LSTM for time series forecasting. (+6 more)
...
### Community 40 - "export_db_to_json.py"
Cohesion: 0.18
Nodes (19): _count_label(), export_experiments(), export_feature_importances(), export_info_cards(), export_metrics(), export_run_models(), export_runs(), main() (+11 more)

### Community 41 - "test_dl_v3.py"
Cohesion: 0.10
...
### Community 42 - "eda_audit_phase1.py"
Cohesion: 0.18
...
### Community 43 - "impute_missing_data"
Cohesion: 0.13
Nodes (16): prepare_data(), DataFrame, Export ARIMA and SARIMA predictions for AVP dashboard integration.  Runs rolli, Load → clean → impute (same as arima_multi_horizon.py)., export_gru(), export_lgbm(), main(), prepare_data() (+8 more)

### Community 44 - "retrain_v7_full.py"
Cohesion: 0.20
Nodes (17): eval_model(), main(), v7 Full Pipeline Retrain — After outlier fix (PM2.5 domain bounds).  Runs ALL, Train, predict, evaluate., LightGBM with Optuna-tuned hyperparameters., RF, GradientBoosting, Stacking, Ensemble., ARIMA/SARIMA with rolling window., GRU/LSTM v2+log with MPS acceleration. (+9 more)

### Community 45 - "citations.py"
Cohesion: 0.14
...
### Community 46 - "_clip_physical_bounds"
Cohesion: 0.16
...
### Community 47 - "load_raw_data"
Cohesion: 0.12
Nodes (15): prepare_data(), DataFrame, Load, clean (v7 outlier fix), impute, build features., load_raw_data(), DataFrame, Path, Check that all expected columns exist., Load raw PM2.5 dataset from CSV.      Args:         path: Path to CSV file. Defa (+7 more)
...
### Community 50 - "patch_v9_metrics.py"
Cohesion: 0.21
...
### Community 53 - "ensemble_multi_horizon.py"
Cohesion: 0.18
...
### Community 54 - "audit_v9_expert_results.py"
Cohesion: 0.21
...
### Community 55 - "statistical_tests.py"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (14): Unified Visualization Theme Framework (VTF) for PM2.5 Dashboard.  Provides centr, apply_mpl_theme(), apply_plotly_style(), detect_streamlit_mode(), get_plotly_annotation_style(), get_plotly_template(), get_theme(), Unified Visualization Theme — Single Source of Truth.  Centralized design toke (+6 more)

### Community 57 - "prediction_intervals.py"
Cohesion: 0.19
...
### Community 58 - "LightGBMTrainer"
Cohesion: 0.15
Nodes (8): GRUTrainer, LightGBMTrainer, Save model to user_trained directory., Log run to dashboard_runs., Train GRU with user-specified params., Train and evaluate GRU., Export GRU to TorchScript and save., Train LightGBM with user-specified params.

### Community 59 - "StandardScaler"
Cohesion: 0.18
...
### Community 60 - "_remove_duplicates"
Cohesion: 0.19
Nodes (10): analyze_segments(), main(), DataFrame, EDA: Analyze contiguous segments at multiple resolutions.  Usage:     uv run pyt, Analyze contiguous non-NaN segments in PM2.5 column., Remove duplicate rows, keeping first occurrence., _remove_duplicates(), Step 4: Feature Engineering. (+2 more)

### Community 61 - "v8_aci_prediction_intervals.py"
Cohesion: 0.19
...
Cohesion: 0.21
Nodes (13): get_audit_report(), get_data_hashes(), get_model_weights(), _md5_file(), Path, Audit router — Data & model hash verification.  Endpoints:     GET /audit/dat, Generate full audit report (data + models)., Compute MD5 hash of a file. (+5 more)

### Community 63 - "knowledge_base.py"
Cohesion: 0.22
...
### Community 64 - "create_calendar_features"
Cohesion: 0.21
...
### Community 65 - "arima_multi_horizon.py"
Cohesion: 0.22
Nodes (12): _evaluate_horizon(), _find_orders(), main(), _prepare_hybrid_data(), DataFrame, Series, ARIMA/SARIMA Multi-Horizon Evaluation — Level 1 Statistical Models.  Compare A, Load raw data and apply Hybrid imputation strategy. (+4 more)

### Community 66 - "v9_statistical_methods.py"
Cohesion: 0.24
Nodes (12): compute_unified_mase(), get_actuals(), _load_latest(), load_predictions(), load_targets(), main(), ndarray, V9 Statistical Methodology — Cross-Resolution MASE + DM-HLN + R².  Loads exist (+4 more)

### Community 67 - "deep_insights_phase4.py"
Cohesion: 0.27
...
### Community 70 - "v8_audit_knn_temporal.py"
Cohesion: 0.24
...
### Community 72 - "_cubic_spline_fill"
Cohesion: 0.18
...
### Community 73 - "residual_diagnostics.py"
Cohesion: 0.23
Nodes (11): _ensure_statsmodels(), _generate_diagnostic_chart(), _ljung_box_test(), ndarray, Path, Residual Diagnostics — Post-model residual analysis.  Implements Peixeiro Ch.6, Run Ljung-Box test at multiple lags.      Ref: Peixeiro Ch.6 — "If p > 0.05, r, Generate 4-panel residual diagnostic chart.      Layout (Peixeiro Fig 6.6 styl (+3 more)

### Community 74 - "create_lag_features"
Cohesion: 0.26
...
### Community 76 - "precompute_avp.py"
Cohesion: 0.25
...
### Community 78 - "multi_horizon_eval.py"
Cohesion: 0.29
...
### Community 79 - "annotation_bbox"
Cohesion: 0.29
Nodes (9): main(), plot_missing_barcode(), plot_recovery_bar(), DataFrame, Khoảng trống chất lượng (Data Quality Gaps) Mục tiêu: Kể câu chuyện về sự không, Vẽ mã vạch (barcode) thể hiện các thời điểm bị mất dữ liệu., Vẽ biểu đồ các loại gap., annotation_bbox() (+1 more)

### Community 80 - "export_eda_plotly_cache.py"
Cohesion: 0.38
...
### Community 83 - "TestResidualDiagnostics"
Cohesion: 0.20
Nodes (6): White noise residuals should pass diagnostics., Autocorrelated residuals should fail Ljung-Box., Verify output dictionary structure., Verify chart is generated when output_dir is provided., P0-5: Residual Diagnostics — Peixeiro Ch.6., TestResidualDiagnostics
...
### Community 88 - "run_enhanced_pipeline.py"
Cohesion: 0.31
Nodes (8): _create_v2_snapshot(), main(), _prepare_hybrid_data(), _print_comparison(), Enhanced Pipeline Runner — Re-evaluate LightGBM with new features.  Runs Light, Load raw data and apply Hybrid imputation strategy., Create v2 dashboard snapshot combining linear + LightGBM results., Print LightGBM v1 vs v2 comparison from saved data.
...
### Community 96 - "01_autocorrelation_trap.py"
Cohesion: 0.36
...
### Community 97 - "02_erratic_spikes.py"
Cohesion: 0.36
...
### Community 98 - "03_multivariate_shift.py"
Cohesion: 0.36
...
### Community 99 - "metrics.py"
Cohesion: 0.32
Nodes (7): classification_metrics(), _compute_roc_auc(), pollution_event_f1(), Evaluation metrics for time series forecasting.  Implements SKILL.md §9 metrics:, Classification metrics for threshold exceedance.      Evaluates how well the mod, Compute ROC-AUC from regression predictions.      Uses sigmoid-scaled distance f, F1-Score for WHO PM2.5 Severe Pollution Threshold Exceedance.      Measures capa

### Community 100 - "create_diff_features"
Cohesion: 0.32
...
### Community 104 - "split_real_imputed"
Cohesion: 0.33
...
### Community 105 - "validate_data_path"
Cohesion: 0.38
...
### Community 107 - "update_memory.py"
Cohesion: 0.47
...
### Community 108 - "v9_standardize_evaluation.py"
Cohesion: 0.47
...
### Community 109 - "validate_snapshot"
Cohesion: 0.40
...
### Community 111 - "test_features.py"
Cohesion: 0.33
...
### Community 112 - "TestDataIntegrity"
Cohesion: 0.33
...
### Community 114 - "reproduce.sh"
Cohesion: 0.70
Nodes (4): err(), log(), reproduce.sh script, warn()

### Community 116 - "precompute_avp_safe.py"
Cohesion: 0.50
...
- **Why does `build_features()` connect `build_features` to `evaluate_forecast`, `_set_datetime_index`, `pipeline_walkthrough.py`, `inference.py`, `impute_missing_data`, `retrain_v7_full.py`, `load_raw_data`, `save_marts_data`, `temporal.py`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `_remove_duplicates`, `create_calendar_features`, `deep_insights_phase4.py`, `create_lag_features`, `precompute_avp.py`, `multi_horizon_eval.py`, `create_rolling_features`, `run_enhanced_pipeline.py`, `shap_explainability.py`, `linear_models_eval.py`, `sklearn_models_eval.py`, `create_diff_features`, `test_features.py`?**
  _High betweenness centrality (0.181) - this node is a cross-community bridge._
- **Why does `load_raw_data()` connect `load_raw_data` to `run_full_eda`, `DataValidator`, `test_loader.py`, `build_features`, `evaluate_forecast`, `_set_datetime_index`, `_resample`, `pipeline_walkthrough.py`, `impute_missing_data`, `retrain_v7_full.py`, `_clip_physical_bounds`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `_remove_duplicates`, `arima_multi_horizon.py`, `deep_insights_phase4.py`, `v8_audit_knn_temporal.py`, `precompute_avp.py`, `multi_horizon_eval.py`, `standardize_metrics.py`, `run_enhanced_pipeline.py`, `shap_explainability.py`, `dl_multi_horizon.py`, `linear_models_eval.py`, `sklearn_models_eval.py`, `validate_data_path`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `impute_missing_data()` connect `impute_missing_data` to `build_features`, `evaluate_forecast`, `_set_datetime_index`, `_resample`, `pipeline_walkthrough.py`, `_identify_gaps`, `test_imputer.py`, `_log`, `retrain_v7_full.py`, `_clip_physical_bounds`, `load_raw_data`, `ensemble_multi_horizon.py`, `statistical_tests.py`, `prediction_intervals.py`, `_remove_duplicates`, `arima_multi_horizon.py`, `deep_insights_phase4.py`, `_cubic_spline_fill`, `precompute_avp.py`, `multi_horizon_eval.py`, `standardize_metrics.py`, `run_enhanced_pipeline.py`, `shap_explainability.py`, `dl_multi_horizon.py`, `linear_models_eval.py`, `sklearn_models_eval.py`, `split_real_imputed`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **What connects `version`, `generated_at`, `models` to the rest of the system?**
  _129 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `run_full_eda` be split into smaller, more focused modules?**
