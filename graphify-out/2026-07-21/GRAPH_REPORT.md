...
## Summary
- 2479 nodes · 4667 edges · 294 communities (147 shown, 147 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2ace117`
...
## Communities (294 total, 147 thin omitted)

### Community 0 - "impute_missing_data"
Cohesion: 0.04
Nodes (65): main(), v8 Phase 4.1 — Re-impute data with KNN past-only fix.  Runs: Raw → Clean → Imp, build_pipeline(), main(), v9 Phase 5A — Rebuild data at high resolution with segment-aware features.  Bu, Run the full data pipeline at a given frequency.      Args:         freq: Res, _apply_knn_imputation(), _build_knn_features() (+57 more)

### Community 1 - "load_raw_data"
Cohesion: 0.06
Nodes (70): main(), Compare Data Strategies — Run all 4 imputation strategies and evaluate.  PRINC, Save results to JSON., _save_results(), main(), prepare_data(), P0-8 — Deseasonalizing Transform Experiment.  Hypothesis: PM2.5 has strong dai, Load → clean → impute → build_features (v2). (+62 more)

### Community 2 - "DataValidator"
Cohesion: 0.08
...
### Community 3 - "app.py"
Cohesion: 0.06
Nodes (62): _count_tests(), _get_pipeline_metrics(), insight_card(), kpi_card(), load_experiment_results(), load_json(), main(), page_content_manager() (+54 more)

### Community 4 - "pages.py"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (23): Cross-reference Audit — Validate ALL experiment results on SAME data.  Purpose:, Debug script — find exact crash point in ensemble pipeline., LSTM/GRU Multi-Horizon Evaluation — Level 4 Deep Learning Models.  Compare LST, add_cv_features(), prepare_data(), DL v3 — PCA Feature Selection for 1h + TFT Retrain with v2 Features.  Tasks:, Load → clean → impute → build_features (v2) → add CV., Add Coefficient of Variation features with safeguard. (+15 more)

### Community 13 - "pipeline_walkthrough.py"
Cohesion: 0.10
...
### Community 14 - "explainability_hub.py"
Cohesion: 0.12
...
### Community 19 - "temporal_train_val_test_split"
Cohesion: 0.09
...
### Community 22 - "snapshot_adapter.py"
Cohesion: 0.11
...
### Community 26 - "v9_retrain_tft.py"
Cohesion: 0.14
...
### Community 27 - "v9_retrain_lgbm.py"
Cohesion: 0.13
...
### Community 35 - "charts.py"
Cohesion: 0.18
Nodes (20): Figure, plot_dm_test_heatmap(), plot_mae_trend(), plot_mae_trend_top5(), plot_mase_comparison(), plot_mase_comparison_top5(), Figure, Reporting Charts — Plotly chart factory for ReportingEngine data.  All charts ar (+12 more)
...
### Community 37 - "build_features"
Cohesion: 0.15
Nodes (17): main(), Compute R², RMSE, MAPE for ALL models across ALL horizons. Generates a complete, main(), _prepare_hybrid_data(), Ensemble Stacking Multi-Horizon — Combine LightGBM + GRU for best performance., # NOTE: torch is lazy-imported in GRU section to avoid MPS/OpenMP conflict with, _save_results(), main() (+9 more)
...
### Community 40 - "eda_audit_phase1.py"
Cohesion: 0.18
...
### Community 41 - "evaluate_forecast_full"
Cohesion: 0.21
...
### Community 42 - "retrain_v7_full.py"
Cohesion: 0.20
...
### Community 43 - "_remove_duplicates"
Cohesion: 0.14
Nodes (15): _prepare_hybrid_data(), DataFrame, ARIMA/SARIMA Multi-Horizon Evaluation — Level 1 Statistical Models.  Compare A, Load raw data and apply Hybrid imputation strategy., _handle_outliers_iqr_all(), main(), DataFrame, v10 Ablation Study — Phase 1: Rebuild data with IQR-truncated PM2.5.  Mô phỏng l (+7 more)

### Community 44 - "v8_statistical_methods.py"
Cohesion: 0.20
...
### Community 47 - "theme.py"
Cohesion: 0.19
Nodes (16): Unified Visualization Theme Framework (VTF) for PM2.5 Dashboard.  Provides centr, apply_mpl_theme(), apply_plotly_style(), detect_streamlit_mode(), get_plotly_annotation_style(), get_plotly_config(), get_plotly_template(), get_theme() (+8 more)

### Community 48 - "chart_factory.py"
Cohesion: 0.13
Nodes (16): Any, Bar, Scatter, add_rangeslider(), figure_caption_numbered(), Plotly Chart Factory — Single Source of Truth for all dashboard charts.  Every P, Render a numbered figure caption per QĐ 1799 format.      Format: "Hình {chapter, Create a ``go.Scatter`` trace with grayscale-safe styling.      Automatically as (+8 more)

### Community 49 - "patch_v9_metrics.py"
Cohesion: 0.21
...
### Community 51 - "run_residual_diagnostics"
Cohesion: 0.19
Nodes (16): dm_test_hln(), _ensure_statsmodels(), _generate_diagnostic_chart(), _ljung_box_test(), Any, ndarray, Path, Residual Diagnostics — Post-model residual analysis.  Implements Peixeiro Ch.6 (+8 more)
...
### Community 56 - "test_evaluation.py"
Cohesion: 0.16
...
### Community 59 - "tune_and_select.py"
Cohesion: 0.25
...
### Community 60 - "v8_aci_prediction_intervals.py"
Cohesion: 0.19
...
### Community 65 - "deep_insights_phase4.py"
Cohesion: 0.27
...
### Community 67 - "run_enhanced_pipeline.py"
Cohesion: 0.24
...
### Community 69 - "v8_audit_knn_temporal.py"
Cohesion: 0.24
...
### Community 71 - "create_lag_features"
Cohesion: 0.26
...
### Community 73 - "v9_statistical_methods.py"
Cohesion: 0.29
...
### Community 75 - "deseasonal_fix_leakage.py"
Cohesion: 0.27
...
### Community 76 - "_evaluate_horizon"
Cohesion: 0.20
Nodes (10): _evaluate_horizon(), _init_torch(), _make_dataset_class(), _make_gru_model(), Create GRU model class with lazy torch import., Train GRU with early stopping., Evaluate LightGBM, GRU, and their ensemble at a specific horizon., Lazy init torch + MPS device. (+2 more)

### Community 77 - "multi_horizon_eval.py"
Cohesion: 0.29
...
### Community 79 - "export_eda_plotly_cache.py"
Cohesion: 0.38
...
### Community 80 - "create_rolling_features"
Cohesion: 0.29
...
### Community 82 - "TestResidualDiagnostics"
Cohesion: 0.20
...
### Community 83 - "TestResultPlausibility"
Cohesion: 0.20
...
### Community 84 - "bootstrap_mase_ci.py"
Cohesion: 0.31
...
### Community 85 - "standardize_metrics.py"
Cohesion: 0.28
...
### Community 87 - "v10_ablation_compare.py"
Cohesion: 0.31
...
### Community 91 - "linear_models_eval.py"
Cohesion: 0.36
...
### Community 92 - "phase1_normalize_snapshots.py"
Cohesion: 0.25
...
### Community 93 - "sklearn_models_eval.py"
Cohesion: 0.36
...
### Community 94 - "01_autocorrelation_trap.py"
Cohesion: 0.36
...
### Community 97 - "create_naive_predictions"
Cohesion: 0.32
...
### Community 99 - "fetch_external_data.py"
Cohesion: 0.33
...
### Community 100 - "validate_data_path"
Cohesion: 0.38
...
### Community 102 - "update_memory.py"
Cohesion: 0.47
...
### Community 103 - "v9_standardize_evaluation.py"
Cohesion: 0.47
...
### Community 104 - "validate_snapshot"
Cohesion: 0.40
...
### Community 105 - "test_features.py"
Cohesion: 0.33
...
### Community 106 - "TestDataIntegrity"
Cohesion: 0.33
...
### Community 108 - "reproduce.sh"
Cohesion: 0.70
Nodes (4): err(), log(), reproduce.sh script, warn()

### Community 111 - "precompute_avp_safe.py"
Cohesion: 0.50
...
### Community 112 - "_tab_pipeline_journey"
Cohesion: 0.50
Nodes (4): Interactive Sankey diagram showing data flow through the pipeline., Render a detailed Sankey for a single resolution, showing every pipeline step., _render_detail_sankey(), _tab_pipeline_journey()

### Community 113 - "get_db"
Cohesion: 0.40
Nodes (4): get_db(), Session, FastAPI dependency — yields a DB session, auto-closes., FastAPI dependencies — DB session, model cache.

### Community 114 - "leakage_audit.py"
Cohesion: 0.50
Nodes (3): p(), Quick leakage audit — verifies specific leakage hypotheses., Print with immediate flush.

### Community 115 - "v9_retrain_ensemble.py"
Cohesion: 0.67
Nodes (3): build_ensemble(), _load_latest(), V9 Ensemble Model Builder.  Combines the best Deep Learning model (LSTM_v9) an

### Community 118 - "palettes.py"
Cohesion: 0.50
...
- **Why does `build_features()` connect `build_features` to `impute_missing_data`, `load_raw_data`, `loader.py`, `pipeline_walkthrough.py`, `inference.py`, `retrain_v7_full.py`, `_remove_duplicates`, `save_marts_data`, `temporal.py`, `LightGBMTrainer`, `statistical_tests.py`, `prediction_intervals.py`, `create_calendar_features`, `deep_insights_phase4.py`, `run_enhanced_pipeline.py`, `create_lag_features`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `create_rolling_features`, `export_models.py`, `linear_models_eval.py`, `sklearn_models_eval.py`, `create_diff_features`, `test_features.py`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `impute_missing_data()` connect `impute_missing_data` to `deep_insights_phase4.py`, `load_raw_data`, `run_enhanced_pipeline.py`, `build_features`, `retrain_v7_full.py`, `_remove_duplicates`, `loader.py`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `pipeline_walkthrough.py`, `_log`, `standardize_metrics.py`, `export_models.py`, `statistical_tests.py`, `prediction_intervals.py`, `linear_models_eval.py`, `sklearn_models_eval.py`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `load_raw_data()` connect `load_raw_data` to `impute_missing_data`, `DataValidator`, `test_loader.py`, `loader.py`, `pipeline_walkthrough.py`, `run_full_eda`, `build_features`, `retrain_v7_full.py`, `_remove_duplicates`, `statistical_tests.py`, `prediction_intervals.py`, `deep_insights_phase4.py`, `run_enhanced_pipeline.py`, `v8_audit_knn_temporal.py`, `deseasonal_fix_leakage.py`, `multi_horizon_eval.py`, `standardize_metrics.py`, `export_models.py`, `linear_models_eval.py`, `sklearn_models_eval.py`, `validate_data_path`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **What connects `version`, `generated_at`, `models` to the rest of the system?**
  _129 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `impute_missing_data` be split into smaller, more focused modules?**
  _Cohesion score 0.04360298336201951 - nodes in this community are weakly interconnected._
- **Should `load_raw_data` be split into smaller, more focused modules?**
