...
def run_error_anatomy(df_feat: pd.DataFrame, results: dict) -> None:
    ...
    plt.suptitle("P1-3: Error Anatomy — GRU v2+log @ h=6", fontsize=14, fontweight="bold", color="#FFD93D")
    plt.tight_layout()
...
def run_cross_correlation(df_feat: pd.DataFrame, results: dict) -> None:
    ...
    plt.suptitle("P1-5: Cross-Correlation — PM2.5 vs External Variables", fontsize=14, fontweight="bold", color="#FFD93D")
    plt.tight_layout()
